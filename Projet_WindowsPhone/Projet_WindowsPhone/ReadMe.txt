================================================================================
    BIBLIOTHÈQUE MICROSOFT FOUNDATION CLASS : Vue d'ensemble du projet Projet_WindowsPhone
===============================================================================

L'Assistant Application a créé cette application Projet_WindowsPhone pour  
...
constituent votre application Projet_WindowsPhone.

Projet_WindowsPhone.vcproj
...
Projet_WindowsPhone.h
    Il s'agit du fichier d'en-tête principal de l'application.  Il contient 
d'autres 
    en-têtes de projet spécifiques et déclare la classe d'application CProjet_WindowsPhoneApp.

Projet_WindowsPhone.cpp
    Il s'agit du fichier source principal de l'application qui contient la 
    classe d'application CProjet_WindowsPhoneApp.


Projet_WindowsPhoneppc.rc
...
res\Projet_WindowsPhoneppc.rc2
...
Projet_WindowsPhoneDlg.h, Projet_WindowsPhoneDlg.cpp – la boîte de dialogue
    Ces fichiers contiennent votre classe CProjet_WindowsPhoneDlg.  Cette classe 
définit 
...
(PCH) 
    nommé Projet_WindowsPhone.pch et un fichier de types précompilés nommé 
StdAfx.obj.
